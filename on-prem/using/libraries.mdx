...
<Note>When you click for the first time on a piece of content, it takes some time because in the background, the documentation is being generated. So, you should be patient; it will load after the generation process.</Note>
