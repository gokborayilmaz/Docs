...
But the Upsonic On-Prem image has pythorch and other big libraries with some ml models. The image is near to 6GB so you should prepare a **7GB** or more gigabayte storage for running an Upsonic in your system.
