...
## Server Requirements
Upsonic On-Prem is designed to work autonomously; however, some systems in our container may consume a significant amount of RAM and CPU, especially due to the inclusion of machine learning models. 
